    ...
    >
      ...
      <div className="mx-auto max-w-6xl px-5">
        <Reveal className="mx-auto max-w-3xl text-center">
          ...
          <h2 className="mt-4 font-display text-[clamp(1.95rem,4.4vw,3.05rem)] font-bold leading-[1.1] tracking-[-0.03em] text-ink">
        ...
        <Reveal className="mt-14 text-center">
          <Link
            href="/services"
            className="inline-flex items-center gap-2 rounded-full border border-ink/[0.12] px-6 py-3 text-[14.5px] font-medium text-ink/80 outline-none transition-colors hover:border-primary/40 hover:text-ink focus-visible:ring-2 focus-visible:ring-primary/50"
          >
